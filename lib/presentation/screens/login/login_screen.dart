 ...
 bool isObsecure=true;
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar( elevation: 0,backgroundColor: AppColors.scaffoldColor,
        ...
        body:SingleChildScrollView(
          child: Center(
            child: Padding(
              ...
              BaseEditText(textController:_textEditingController ,
              inputType: TextInputType.emailAddress,
              placeHolder: 'Email',
              prefixIcon: AssetStrings.icEmail,
              ),
              SpaceHepler.verticalMedium,
              BaseEditText(textController:_passwordController ,
              ...
              suffixWidget:IconButton(
                // splashRadius: 20,
              iconSize: 30,
                icon: SvgPicture.asset('assets/icon/ic_close_eye.svg'),onPressed: () {
                setState(() {
                  isObsecure = !isObsecure;
                });
              },) ,
              ...
              Align(
                ...
                child: Text('Forgot Password?',style:AppTextStyles.disabledText))
              ],),
            ),
          ),
        )
