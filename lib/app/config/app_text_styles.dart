...
class AppTextStyles {
  ...
  static TextStyle placeHolderText({Color? color}) => TextStyle(fontSize: 17.36, color: color ?? AppColors.disabledColor);
  ...
  static TextStyle tileTitle = const TextStyle(fontSize: 16, color: Color(0xFF263238), fontWeight: FontWeight.normal, letterSpacing: 0.12);
  static TextStyle disableText({Color? color}) =>
      TextStyle(fontSize: 15.63, color: color ?? AppColors.disableTextColor, fontWeight: FontWeight.normal, letterSpacing: 0.14);
}
